...
public abstract class RestGetInfoInstitucion extends CoreApiRest {
    int id;

    public RestGetInfoInstitucion(int id) {
        this.id = id;
    }
    ...
    protected String runService() {
        return Api.get(configuracion.getBaseUrl() + "get-info-institucion/" + id);
    }
}
