...
import com.biessap.biessap.Activitys.Universidades.ListaUniversidadActivity;
...
public class ListaInstitutoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_instituto);
    ...
    CardView btn_inicio = findViewById(R.id.btn_inicio);
        ...
        public void onClick(View v) {
            Intent i = new Intent(ListaInstitutoActivity.this, MenuActivity.class);
    ...
    private void obtenerInstitutos() {
        String clase = "instituto";
            ...
            protected void onSuccess(String s) {
                ...
                adapter = new UniversidadAdapter(lista) {
                    ...
                    public void OnItemClick(int pos) {
                       Intent i = new Intent(ListaInstitutoActivity.this,DetalleInstitutoActivity.class);
                ...
                LinearLayoutManager mLayoutManager = new LinearLayoutManager(ListaInstitutoActivity.this);
